...
const ReviewWrite = () => {
    ...
    return (
        <div className="flex flex-col h-full bg-white ">
            <SimpleHeader onBackClick={() => navigate(-1)} />

            <div className="flex-1 overflow-y-auto px-5 py-6 flex flex-col gap-8 pb-32">
                {/* 별점 선택 */}
                <div className="flex flex-col items-center gap-4 py-4 bg-gray-50 rounded-2xl border border-gray-100">
                    <span className="text-gray-500 font-bold text-[15px]">클래스는 어떠셨나요?</span>
                ...
                <div className="flex flex-col gap-3">
                    <h3 className="font-bold text-gray-900 text-[17px]">사진 첨부 (선택)</h3>
                    <PhotoUploader
            ...
            {/* 제출 버튼 */}
            <div className="fixed bottom-0 max-w-[450px] w-full bg-white px-5 py-5 border-t border-gray-100 shadow-[0_-4px_15px_rgba(0,0,0,0.03)] z-50 rounded-t-3xl">
                <CommonButton
                    label="후기 등록하기"
