...
const MarketDetail = () => {
    ...
    const tabData = useMemo(() => {
        ...
        const operatingTimes = data.classTimes.reduce<Record<string, string[]>>((acc, classTime) => {
    ...
    if (isLoading) {
        return <div className="p-10 text-center text-gray-400">클래스 상세를 불러오는 중입니다...</div>;
    }
            ...
            <div className="bg-white px-5 py-6 flex flex-col gap-4 shadow-sm z-10 -mt-4 rounded-t-3xl relative">
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="text-sm text-gray-400">{data.durationMinutes}분 수업</span>
                    </div>
                </div>
            ...
            <div className="fixed bottom-0 max-w-[450px] w-full bg-white px-5 py-4 flex items-center justify-between border-t border-gray-100 shadow-[0_-4px_15px_rgba(0,0,0,0.03)] z-50 rounded-t-2xl">
                <div className="flex flex-col">
                    ...
                    <div className="flex items-center gap-1.5">
                        ...
                        <span className="font-bold text-[22px] text-gray-900 tabular-nums leading-none tracking-tight">{data.priceAmount}</span>
                    </div>
                </div>
