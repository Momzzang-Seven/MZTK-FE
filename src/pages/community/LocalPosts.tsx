...
const LocalPosts = () => {
  ...
  const handleExecute = async (intent: StoredWeb3Action) => {
    navigate(`/verify-wallet/${intent.resource.type}/${intent.resource.id}`, { state: { intent } });
  };
            ...
            >
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className={`text-xs font-medium ${intent.executionIntent.status === 'AWAITING_SIGNATURE' ? 'text-red-500' : 'text-gray-500'}`}>
