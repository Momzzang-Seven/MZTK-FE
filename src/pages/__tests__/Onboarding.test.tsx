...
describe('Onboarding Page', () => {
    ...
    it('온보딩 제목과 설명이 올바르게 렌더링된다', () => {
        ...
        expect(screen.getByText(/지갑을.*생성\/연결 해볼까요\?/)).toBeInTheDocument();
        expect(screen.getByText(/이미 사용 중인 지갑이 없다면/)).toBeInTheDocument();
    });
    ...
    it('지갑 등록하기 버튼 클릭 시 /register-wallet으로 이동한다', () => {
        ...
        const registerButton = screen.getByRole('button', { name: '지갑 등록하기' });
