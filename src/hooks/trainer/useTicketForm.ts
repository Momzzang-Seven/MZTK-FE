...
export const useTicketForm = (mode: "create" | "edit" = "create") => {
    ...
    const [existingSlotIds, setExistingSlotIds] = useState<Record<string, number>>({});
        ...
        const initialize = async () => {
            try {
                ...
                if (
                    ...
                    window.alert("매장 정보를 먼저 등록해야 클래스 등록 및 수정이 가능합니다.");
    ...
    const handleSubmit = async () => {
        ...
        const classTimes: UpdateTrainerClassTimePayload[] = formData.operatingDays.flatMap((day) =>
