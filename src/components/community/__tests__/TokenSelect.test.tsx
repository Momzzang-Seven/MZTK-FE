...
import TokenSelect from "../newPost/TokenSelect";
...
describe("TokenSelect", () => {
  ...
  describe("기본 렌더링", () => {
    it("10부터 100까지 10단위 버튼이 10개 렌더링되어야 한다", () => {
      render(<TokenSelect reward={0} setReward={setRewardMock} />);
  ...
  describe("버튼 클릭 동작", () => {
    ...
    it("reward prop과 동일한 버튼에 선택 스타일(bg-main)이 적용되어야 한다", () => {
      const { rerender } = render(
        <TokenSelect reward={30} setReward={setRewardMock} />
      );
      ...
      rerender(<TokenSelect reward={40} setReward={setRewardMock} />);
