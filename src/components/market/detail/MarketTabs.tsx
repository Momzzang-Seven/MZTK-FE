            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm flex flex-col gap-3.5">
                    {data.features.length > 0 ? (
                        ...
                        <p className="text-[14px] text-gray-400">등록된 프로그램 특징이 없습니다.</p>
                    )}
                </div>
            </div>
            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex flex-col gap-4">
                    ...
                    {data.operatingDays.length > 0 ? (
                        ...
                        <p className="text-[14px] text-gray-400">등록된 운영 시간이 없습니다.</p>
                    )}
                </div>
            </div>
        </>
                ...
                <div className="flex flex-col gap-2 relative">
                    <div className="w-full h-[180px] bg-gray-100 rounded-lg overflow-hidden border border-gray-100 relative shadow-inner">
                        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none opacity-40">
                            ...
                            <span className="text-gray-500 text-xs font-bold font-sans tracking-tight">지도 위치 노출 구역</span>
                        </div>
    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2 mb-2">
                <span className="text-yellow-400 text-xl font-bold">★ {data.rating ?? "0.0"}</span>
                <span className="text-gray-500 font-medium">({data.reviewCount ?? 0}개)</span>
            </div>
