...
export const MnemonicVerify = ({
  ...
  const handlePaste = async () => {
    try {
      ...
      // Fail silently or add toast if needed
    }
  };
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-3">
          ...
          <button
            type="button"
            onClick={handlePaste}
            className="btn-press flex items-center gap-1 px-3 py-1.5 rounded-xl bg-amber-50 text-[12px] font-black text-main border-none"
          >
            붙여넣기
          </button>
        </div>
