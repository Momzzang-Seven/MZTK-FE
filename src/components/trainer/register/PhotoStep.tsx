...
const PhotoStep = ({ imagePreviews, onImageChange, onRemoveImage, triggerFileInput, fileInputRef }: PhotoStepProps) => {
    const mainPreview = imagePreviews.length > 0 ? imagePreviews[imagePreviews.length - 1] : null;
        ...
        <div className="flex flex-col h-full bg-white animate-in fade-in duration-500">
            ...
            <div className="w-full aspect-square bg-gray-50 flex items-center justify-center overflow-hidden border-b border-gray-100">
                {mainPreview ? (
                    ...
                    <div className="flex flex-col items-center gap-3 text-gray-300">
                        <img src="/icon/gallery.svg" alt="gallery" className="w-16 h-16 opacity-30" />
            ...
            <div className="p-4 flex flex-col gap-4">
                <div className="flex justify-between items-center">
                    ...
                    <span className="text-xs font-bold text-gray-400">{imagePreviews.length} / 5</span>
                </div>
                ...
                <div className="grid grid-cols-4 gap-2">
                    ...
                    >
                        <img src="/icon/camera.svg" alt="camera" className="w-6 h-6 opacity-40" />
                    </button>

                    {/* Thumbnails */}
                    {imagePreviews.map((img, idx) => (
                        <div key={idx} className="aspect-square relative rounded-lg overflow-hidden border border-gray-100 group">
