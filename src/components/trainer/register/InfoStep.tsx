...
const InfoStep = ({
    ...
    return (
        <div className="flex flex-col h-full bg-white pb-20 animate-in slide-in-from-right duration-500">
            {/* Instagram Style Top Section */}
            <div className="flex px-4 py-5 gap-4 border-b border-gray-100">
                <div className="w-24 aspect-square rounded-lg overflow-hidden flex-shrink-0 bg-gray-50 border border-gray-100 shadow-sm">
            ...
            <div className="flex flex-col">
                ...
                {/* Schedule Section */}
                <div className="bg-gray-50 px-5 py-8 flex flex-col gap-8">
