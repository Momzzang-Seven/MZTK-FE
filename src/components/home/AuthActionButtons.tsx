...
export const AuthActionButtons = ({
  ...
  const activeStyle =
    "bg-[#FFC107] text-white shadow-lg active:scale-95 border-none cursor-pointer";
  const inactiveStyle =
    "!bg-white border-2 border-dashed border-gray-300 text-gray-400 cursor-default";
  ...
  return (
    <div className="w-full flex flex-col gap-4">
      ...
      <CommonButton
        ...
        label={
          <div className="flex flex-col items-start gap-0.5">
            ...
            <div
              className={`text-[12px] font-medium ${isAttended ? "opacity-70" : "opacity-90"}`}
            >
              {isAttended
        ...
        icon={
          <div
            className={`w-11 h-11 rounded-full flex items-center justify-center shrink-0 ${isAttended ? "bg-transparent" : "bg-white/25"}`}
          >
            <img
              src="/icon/clock.svg"
              alt="clock"
      ...
      <CommonButton
        ...
        label={
          <div className="flex flex-col items-start gap-0.5">
            <div className="font-bold text-[17px]">{exerciseTitle}</div>
            <div
              className={`text-[12px] font-medium ${isExerciseLocked ? "opacity-70" : "text-white/90"}`}
            >
              {exerciseDesc}
            </div>
          </div>
        ...
        icon={
          <div
            className={`w-11 h-11 rounded-full flex items-center justify-center shrink-0 ${isExerciseLocked ? "bg-transparent" : "bg-white/25"}`}
          >
            <img
