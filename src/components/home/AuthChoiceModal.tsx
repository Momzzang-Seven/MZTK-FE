      ...
      <div className="relative bg-white rounded-[32px] w-full max-w-sm p-8 shadow-2xl animate-fade-in-up z-10">
        ...
        <div className="flex justify-between items-center">
          ...
          >
            ...
            <span className="text-base font-bold text-[#FAB12F]">
              {HOME_TEXT.MODAL.LOCATION}
            </span>
          </button>
          ...
          >
            <div className="w-12 h-12 flex items-center justify-center mb-1">
              <div className="w-10 h-10 bg-[#FAB12F] [mask-image:url(/icon/dumbell.svg)] [webkit-mask-image:url(/icon/dumbell.svg)] [mask-size:contain] [mask-repeat:no-repeat] [mask-position:center]" />
            </div>
            <span className="text-base font-bold text-[#FAB12F]">
              {HOME_TEXT.MODAL.EXERCISE}
            </span>
          </button>
          ...
          >
            <div className="w-12 h-12 flex items-center justify-center mb-1">
              <div className="w-10 h-10 bg-[#FAB12F] [mask-image:url(/icon/record.svg)] [webkit-mask-image:url(/icon/record.svg)] [mask-size:contain] [mask-repeat:no-repeat] [mask-position:center]" />
            </div>
            <span className="text-base font-bold text-[#FAB12F]">
              {HOME_TEXT.MODAL.RECORD}
            </span>
          </button>
        </div>
      </div>
